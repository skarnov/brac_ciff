...
(1, 0, 1, 1, 'Jashore DRSC', 'Khulna', 'Jashore', '', '', NULL, NULL, '17:34:41', '2020-09-23', 2, '17:34:41', '2020-09-23', 2);
...
CREATE TABLE `dev_complains` (
  ...
  `type_recipient` text,
  `type_service` text,
  `other_type_service` text,
  `know_service` text,
  `other_know_service` text,
...
CREATE TABLE `dev_customer_skills` (
  ...
  `have_skills` text,
  `other_have_skills` text,
  `vocational_skill` text,
  `handicraft_skill` text,
  `update_date` date DEFAULT NULL,
  `update_time` time DEFAULT NULL,
  `updated_by` bigint(20) DEFAULT NULL,
  `create_date` date DEFAULT NULL,
...
CREATE TABLE `dev_economic_profile` (
  ...
  `current_residence_ownership` text,
...
CREATE TABLE `dev_economic_reintegration_referrals` (
  ...
  `received_vocational_training` text,
  `other_received_vocational_training` text,
  `training_start_date` date DEFAULT NULL,
  `training_end_date` date DEFAULT NULL,
  `is_vocational_training` enum('yes','no') DEFAULT NULL,
  `received_vocational` text,
  `other_received_vocational` text,
  `other_comments` text,
  `is_economic_services` enum('yes','no') DEFAULT NULL,
  `economic_support` text,
  `economic_financial_service` text,
  `other_economic_support` text,
  `is_assistance_received` enum('yes','no') DEFAULT NULL,
  `refferd_to` text,
  `trianing_date` date DEFAULT NULL,
  `place_of_training` text,
  `duration_training` text,
  `refferd_address` text,
  `status_traning` text,
  `assistance_utilized` text,
...
CREATE TABLE `dev_followups` (
  ...
  `reason_dropping` text COLLATE utf8_unicode_ci,
  `other_reason_dropping` text COLLATE utf8_unicode_ci,
  `confirm_services` text COLLATE utf8_unicode_ci,
  `followup_financial_service` text COLLATE utf8_unicode_ci,
  `social_protection` text COLLATE utf8_unicode_ci,
  `special_security` text COLLATE utf8_unicode_ci,
  `comment_psychosocial` text COLLATE utf8_unicode_ci,
  `comment_psychosocial_date` date DEFAULT NULL,
  `comment_economic` text COLLATE utf8_unicode_ci,
  `comment_economic_date` date DEFAULT NULL,
  `comment_social` text COLLATE utf8_unicode_ci,
  `comment_social_date` date DEFAULT NULL,
  `comment_income` text COLLATE utf8_unicode_ci,
  `comment_income_date` date DEFAULT NULL,
  `monthly_income` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL,
  `challenges` text COLLATE utf8_unicode_ci,
  `actions_taken` text COLLATE utf8_unicode_ci,
  `remark_participant` text COLLATE utf8_unicode_ci,
  `comment_brac` text COLLATE utf8_unicode_ci,
  `remark_district` text COLLATE utf8_unicode_ci,
  `update_date` date DEFAULT NULL,
  `update_time` time DEFAULT NULL,
  `updated_by` bigint(20) DEFAULT NULL,
  `create_date` date DEFAULT NULL,
...
--
-- Table structure for table `dev_meeting_entries`
--

CREATE TABLE `dev_meeting_entries` (
  `pk_meeting_entry_id` bigint(20) NOT NULL,
  `fk_branch_id` int(10) NOT NULL,
  `month` int(2) NOT NULL,
  `fk_project_id` int(10) NOT NULL,
  `fk_meeting_id` bigint(20) NOT NULL,
  `meeting_entry_division` varchar(100) DEFAULT NULL,
  `meeting_entry_district` varchar(100) DEFAULT NULL,
  `meeting_entry_upazila` varchar(80) DEFAULT NULL,
  `meeting_entry_union` varchar(80) DEFAULT NULL,
  `meeting_entry_location` text,
  `meeting_entry_village` varchar(150) DEFAULT NULL,
  `meeting_entry_ward` varchar(150) DEFAULT NULL,
  `meeting_entry_start_date` date DEFAULT NULL,
  `meeting_entry_start_time` time DEFAULT NULL,
  `meeting_entry_end_date` date DEFAULT NULL,
  `meeting_entry_end_time` time DEFAULT NULL,
  `participant_boy` tinyint(2) DEFAULT NULL,
  `participant_girl` tinyint(2) DEFAULT NULL,
  `participant_male` tinyint(2) DEFAULT NULL,
  `participant_female` tinyint(2) DEFAULT NULL,
...
--
-- Table structure for table `dev_meeting_targets`
--

CREATE TABLE `dev_meeting_targets` (
  `pk_meeting_target_id` bigint(20) NOT NULL,
  `fk_project_id` int(10) NOT NULL,
  ...
  `fk_meeting_id` bigint(20) NOT NULL,
  `meeting_target` int(5) DEFAULT NULL,
  ...
  `meeting_achievement` int(5) DEFAULT '0',
  `create_time` time DEFAULT NULL,
  `create_date` date DEFAULT NULL,
  `created_by` bigint(20) DEFAULT NULL,
  `update_time` time DEFAULT NULL,
...
CREATE TABLE `dev_migrations` (
  ...
  `migration_medias` text,
  `migration_occupation` varchar(150) DEFAULT NULL,
  `destination_country_leave_reason` text,
  `other_destination_country_leave_reason` text,
  ...
  `migration_reasons` text,
  `other_migration_reason` text,
  `update_date` date DEFAULT NULL,
  `update_time` time DEFAULT NULL,
  `updated_by` bigint(20) DEFAULT NULL,
  `create_date` date DEFAULT NULL,
...
CREATE TABLE `dev_psycho_completions` (
  ...
  `dropout_reason` text COLLATE utf8_unicode_ci,
...
CREATE TABLE `dev_psycho_family_counselling` (
  ...
  `session_place` text COLLATE utf8_unicode_ci,
...
CREATE TABLE `dev_psycho_followups` (
  ...
  `entry_date` date DEFAULT NULL,
  `entry_time` time NOT NULL,
  `followup_comments` text COLLATE utf8_unicode_ci,
  `update_date` date DEFAULT NULL,
  `update_time` time DEFAULT NULL,
  `updated_by` bigint(20) DEFAULT NULL,
  `create_date` date DEFAULT NULL,
...
CREATE TABLE `dev_psycho_sessions` (
  ...
  `session_comments` text COLLATE utf8_unicode_ci,
  `activities_description` text COLLATE utf8_unicode_ci,
...
CREATE TABLE `dev_psycho_supports` (
  ...
  `initial_plan` text COLLATE utf8_unicode_ci,
  ...
  `session_place` text COLLATE utf8_unicode_ci,
  `other_requirements` text COLLATE utf8_unicode_ci,
  `reffer_to` text COLLATE utf8_unicode_ci,
  `referr_address` text COLLATE utf8_unicode_ci,
  ...
  `other_reason_for_reffer` text COLLATE utf8_unicode_ci,
  `update_date` date DEFAULT NULL,
  `update_time` time DEFAULT NULL,
  `updated_by` bigint(20) DEFAULT NULL,
  `create_date` date DEFAULT NULL,
...
CREATE TABLE `dev_reintegration_plan` (
  ...
  `reintegration_financial_service` text COLLATE utf8_unicode_ci,
  `service_requested` text COLLATE utf8_unicode_ci,
  `other_service_requested` text COLLATE utf8_unicode_ci,
  `social_protection` text COLLATE utf8_unicode_ci,
  `security_measure` text COLLATE utf8_unicode_ci,
  `service_requested_note` text COLLATE utf8_unicode_ci,
  `update_date` date DEFAULT NULL,
  `update_time` time DEFAULT NULL,
  `updated_by` bigint(20) DEFAULT NULL,
  `create_date` date DEFAULT NULL,
...
CREATE TABLE `dev_returnees` (
  ...
  `legal_document` text,
  `other_legal_document` text,
  `remigrate_intention` enum('yes','no') DEFAULT NULL,
  `destination_country_profession` text,
...
CREATE TABLE `dev_social_supports` (
  ...
  `fk_customer_id` bigint(20) NOT NULL,
  `reintegration_economic` text,
  `other_reintegration_economic` text,
  ...
  `support_referred` text,
  `other_support_referred` text,
  `update_date` date DEFAULT NULL,
  `update_time` time DEFAULT NULL,
  `updated_by` bigint(20) DEFAULT NULL,
  `create_date` date DEFAULT NULL,
...
CREATE TABLE `dev_users` (
  ...
  `user_description` text COLLATE utf8_unicode_ci,
  ...
  `user_password_reset_link` text COLLATE utf8_unicode_ci,
  `user_email_verification_code` text COLLATE utf8_unicode_ci,
  `user_private_token` text COLLATE utf8_unicode_ci,
...
(1, 'Demo User has logged out.', '', 'logout', 'success', '2020-12-20 14:40:26', 2),
...
--
-- Indexes for table `bd_divisions`
--
ALTER TABLE `bd_divisions`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `bd_unions`
--
...
--
-- Indexes for table `dev_meeting_entries`
--
ALTER TABLE `dev_meeting_entries`
  ADD PRIMARY KEY (`pk_meeting_entry_id`);

--
-- Indexes for table `dev_meeting_targets`
--
ALTER TABLE `dev_meeting_targets`
  ADD PRIMARY KEY (`pk_meeting_target_id`);
...
--
-- AUTO_INCREMENT for table `bd_divisions`
--
ALTER TABLE `bd_divisions`
  MODIFY `id` int(1) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `bd_unions`
--
ALTER TABLE `bd_unions`
  MODIFY `id` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4541;

--
-- AUTO_INCREMENT for table `bd_upazilas`
--
ALTER TABLE `bd_upazilas`
...
--
ALTER TABLE `dev_branches`
  MODIFY `pk_branch_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `dev_meetings`
  MODIFY `pk_meeting_id` int(2) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `dev_meeting_entries`
--
ALTER TABLE `dev_meeting_entries`
  MODIFY `pk_meeting_entry_id` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `dev_meeting_targets`
--
ALTER TABLE `dev_meeting_targets`
  MODIFY `pk_meeting_target_id` bigint(20) NOT NULL AUTO_INCREMENT;

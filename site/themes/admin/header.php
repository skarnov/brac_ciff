...
<html class="gt-ie8 gt-ie9 not-ie">
    ...
    <head>
        ...
        ?>
        <?php minify_handler::renderMinifiedCss('assets', 4); ?>
        ...
        <link href="<?php echo theme_path(); ?>/assets/stylesheets/dev_style.css?v=46" rel="stylesheet" type="text/css">
        ...
        <script type="text/javascript">
            ...
            function releasePreventDoubleClick(form, submitForm) {
                ...
                if (_type.toLowerCase() == 'input') {
                    ...
                    btn.removeClass('disabled').html(btn.attr('data-old'));
                }
    ...
    <body onbeforeunload="showLoading()" class="theme-<?php echo $_config['adminTheme'] ? $_config['adminTheme'] : 'default' ?> main-menu-animated <?php echo $_config['mainNavMenuToRight'] ? 'main-menu-right' : '' ?>  main-navbar-fixed main-menu-fixed hanging_footer .fixed_footer .mmc <?php echo getProjectSettings('features,backend_left_menu') ? '' : ''; ?>">
        <script type="text/javascript">
            addLoading();
            showLoadingJS();
        </script>
                                    ...
                                    if (count($_config['langs']) > 1) {
                                        ...
                                        <li class="dropdown" style="">
                                            <a href="#" class="dropdown-toggle lang-menu" data-toggle="dropdown">
                                                <span><?php echo $_config['langs'][$_config['slang']]['title'] ?>&nbsp;<i class="fa fa-caret-down"></i></span>
                                            </a>

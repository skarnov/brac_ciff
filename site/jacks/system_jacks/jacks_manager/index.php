...
class dev_jacks_manager{
    ...
    function adm_menus(){
        ...
        if(has_project_settings('admin_menu,manage_jacks') && HAS_USER('sadmin')) admenu_register($params);
        ...
        if(has_project_settings('admin_menu,admin_options') && HAS_USER('sadmin')) admenu_register($params);
        }

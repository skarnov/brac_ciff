        ...
        <div class="col-md-4">
            <div class="stat-row">
                <div class="stat-cell bg-warning">
                    <span class="text-bg"><?php echo $study_reports['total'] ?></span><br>
...
<div class="table-primary table-responsive">
    ...
    <?php endif; ?>
    <div class="table-header">
        <?php echo searchResultText($study_reports['total'], $start, $per_page_items, count($study_reports['data']), 'case study') ?>
    </div>

...
if ($filter_customer_skills) {
    ...
    $sql = "SELECT full_name, customer_id, present_house, present_road, present_village, present_post_office, present_police_station, present_sub_district, present_district, lookup_value, column_name FROM dev_customers LEFT JOIN dev_lookup_relation ON (dev_lookup_relation.fk_output_id = dev_customers.pk_customer_id) WHERE column_name = 'need_skills' " . $search . 'GROUP BY full_name';
    ...
    <div class="oh">
        <div class="btn-group btn-group-sm">
            ...
            echo linkButtonGenerator(array(
                ...
                'action' => 'download',
                'icon' => 'icon_edit',
                'text' => 'Download Income Earner Skills By Beneficiary',
                'title' => 'Download Income Earner Skills By Beneficiary Report',
            ));
            ?>
        </div>
    </div>

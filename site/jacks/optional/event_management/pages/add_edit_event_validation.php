...
if ($_POST) {
    ...
    if ($ret) {
        ...
        if ($edit) {
            header('location: ' . url('admin/dev_event_management/manage_event_validations?action=add_edit_event_validation&edit=' . $edit));
        } else {
...
<form id="theForm" onsubmit="return true;" method="post" action="" enctype="multipart/form-data">
    <div class="panel" id="fullForm" style="">
        ...
        <div class="panel-footer tar">
            <a href="<?php echo url('admin/dev_event_management/manage_event_validations') ?>" class="btn btn-flat btn-labeled btn-danger"><span class="btn-label icon fa fa-times"></span>Cancel</a>
            <?php

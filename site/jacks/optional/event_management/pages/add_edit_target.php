...
if ($edit) {
    $pre_data = $this->get_targets(array('target_id' => $edit, 'single' => true));
...
if ($_POST) {
    ...
    if ($ret['target_insert'] || $ret['target_update']) {
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="target_id" value="<?php echo $pre_data['target_id'] ? $pre_data['target_id'] : ''; ?>">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input id="birthdate" type="text" class="form-control" name="target_birthdate" value="<?php echo $pre_data['target_birthdate'] && $pre_data['target_birthdate'] != '0000-00-00' ? date('d-m-Y', strtotime($pre_data['target_birthdate'])) : date('d-m-Y'); ?>">
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="target_mobile" value="<?php echo $pre_data['target_mobile'] ? $pre_data['target_mobile'] : ''; ?>">
                                    </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form_element_holder radio_holder radio_holder_static_featured_show_link">
                                            <div class="options_holder radio">
                                                <label><input class="px oldGender" type="radio" name="target_gender" value="male" <?php echo $pre_data && $pre_data['target_gender'] == 'male' ? 'checked' : '' ?>><span class="lbl">Male</span></label>
                                                <label><input class="px oldGender" type="radio" name="target_gender" value="female" <?php echo $pre_data && $pre_data['target_gender'] == 'female' ? 'checked' : '' ?>><span class="lbl">Female</span></label>
                                                <label><input class="px" type="radio" name="target_gender" id="newGender"><span class="lbl">Other</span></label>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div id="spouse" style="display: none; margin-bottom: 1em;">
                                        <input class="form-control" placeholder="Enter Spouse Name" type="text" name="target_spouse" value="<?php echo $pre_data['target_spouse'] ? $pre_data['target_spouse'] : ''; ?>">
                                    </div>
                                    <script>
                                        init.push(function () {
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div id="documentUploads" style="display: none">
                                        ...
                                        <div class="col-md-5">
                                            ...
                                            <div class="form-group">
                                                <input type="file" class="form-control" name="target_photo[]" />
                                            </div>
                                        </div>

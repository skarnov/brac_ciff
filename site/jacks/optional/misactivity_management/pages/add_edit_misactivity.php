...
if ($_POST) {
    ...
    if ($ret) {
        ...
        if ($edit) {
            header('location: ' . url('admin/dev_misactivity_management/manage_misactivities?action=add_edit_misactivity&edit=' . $edit));
        } else {
            header('location: ' . url('admin/dev_misactivity_management/manage_misactivities'));
        }
        exit();
    } else {
        $pre_data = $_POST;
...
<form id="theForm" onsubmit="return true;" method="post" action="" enctype="multipart/form-data">
    <div class="panel" id="fullForm" style="">
        ...
        <div class="panel-footer tar">
            <a href="<?php echo url('admin/dev_misactivity_management/manage_misactivities') ?>" class="btn btn-flat btn-labeled btn-danger"><span class="btn-label icon fa fa-times"></span>Cancel</a>
            <?php

...
<form id="theForm" onsubmit="return true;" method="post" action="" enctype="multipart/form-data">
    <div class="panel" id="fullForm" style="">
        <div class="panel-body">
            ...
            <?php if ($pre_data) { ?>
                <div class="col-md-12">
                    <label><?php echo $pre_data['activity_name'] ?> - Target &nbsp;</label>
                    <input type="hidden" name="activity_id" value="<?php echo $pre_data['fk_activity_id'] ?>" class="form-control">
                    <input type="number" name="target" value="<?php echo $pre_data['activity_target'] ?>" class="form-control" style="display: inline; width: 60%;">
                    <br/>
                    <br/>
                </div>
            <?php } else { ?>
                <div class="col-md-12">
                    ...
                    foreach ($all_activities['data'] as $value) {
                        ?>
                        <label><?php echo $value['activity_name'] ?> - Target &nbsp;</label>
                        <input type="hidden" name="activity_id[]" value="<?php echo $value['pk_activity_id'] ?>" class="form-control">
        ...
        <div class="panel-footer tar">
            <a href="<?php echo url('admin/dev_misactivity_management/manage_targets') ?>" class="btn btn-flat btn-labeled btn-danger"><span class="btn-label icon fa fa-times"></span>Cancel</a>
            <?php

...
class dev_tag_management{
    ...
    public function get_contents_by_tag_title($tag_title, $content_type = 'content', $tag_type = 'tag'){
	    global $devdb;



	    $SQL = "SELECT dev_content_tag_relation.fk_content_id 
                FROM 
                  dev_content_tag_relation 
                  INNER JOIN dev_tags ON (dev_content_tag_relation.fk_tag_id=dev_tags.pk_tag_id) 
                  WHERE 
                    dev_content_tag_relation.content_type = '$content_type' 
                    AND dev_content_tag_relation.tag_type = '$tag_type' 
                    AND dev_tags.tag_title LIKE '%$tag_title%'";
    ...
    public function get_contents_by_tag_id($tag_id, $content_type = 'content', $tag_type = 'tag'){
        global $devdb;
        ...
        $SQL = "SELECT dev_content_tag_relation.fk_content_id 
                FROM 
                  ...
                  WHERE 
                    dev_content_tag_relation.content_type = '$content_type' 
                    AND dev_content_tag_relation.tag_type = '$tag_type' 
                    AND dev_content_tag_relation.fk_tag_id = '$tag_id'";

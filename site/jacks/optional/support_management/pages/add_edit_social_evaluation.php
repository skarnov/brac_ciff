...
$pre_data = array();
if ($edit) {
    $pre_data = $this->get_social_evaluation(array('id' => $edit, 'single' => true));
...
if ($_POST) {
    ...
    $ret = $this->add_edit_social_evaluation($data);
...
<div class="page-header">
    <h1><?php echo $edit ? 'Update ' : 'New ' ?>Social Evaluation</h1>
    <div class="oh">
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <input type="hidden" name="fk_social_support_id" value="<?php echo $_GET['support_id'] ?>"/>

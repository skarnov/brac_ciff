...
$pre_data = array();
if ($edit) {
    $pre_data = $this->get_evaluation(array('id' => $edit, 'single' => true));
...
if ($_POST) {
    ...
    $ret = $this->add_edit_evaluation($data);
    ...
    if ($ret['success']) {
        ...
        header('location: ' . url('dev_support_management/manage_supports'));
        exit();
    } else {
        $pre_data = $_POST;
...
<div class="page-header">
    <h1><?php echo $edit ? 'Update ' : 'New ' ?>Psychosocial Evaluation</h1>
    <div class="oh">

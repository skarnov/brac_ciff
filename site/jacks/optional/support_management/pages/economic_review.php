...
if (!checkPermission($id, 'add_support', 'edit_support')) {
...
if ($id) {
    ...
    if ($pre_data['support_name'] == 'economic') {        
        $baseline_evaluations = $this->get_economic_evaluation(array('customer_id' => $pre_data['fk_customer_id'], 'support_id' => 0, 'single' => false));
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <?php
                            foreach ($baseline_evaluations['data'] as $economic_evaluation) {
                                ?>
                                <tr>
